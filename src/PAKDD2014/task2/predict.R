...
source("_include.R")
setwd("D:/Education/R/HomeWork/ITIS-R-Homework/src/PAKDD2014/task2/data")  # Директория с данными
...
setwd("D:/Education/R/HomeWork/ITIS-R-Homework/src/PAKDD2014/task2/out")  # Директория для вывода
...
for(i in 1:length(module.component[,1]))
{
  ...
  predicted <- rbind(predicted, exp.predict(module, component, sale=sale.src, repair=repair.src, rate))
}
